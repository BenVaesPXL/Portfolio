    ...
    >
      ...
      >
        <SkillIcon
          ...
          "
          tooltip="Vue.js for frontend development"
        />
        <SkillIcon
          name="JavaScript"
          icon="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/javascript/javascript-original.svg"
          tooltip="JavaScript for frontend and backend development"
        />
        <SkillIcon
          name="Tailwind CSS"
          icon="
          ...
          "
          tooltip="Tailwind CSS for styling this site"
        />
        <SkillIcon
          name="SCSS"
        ...
        <SkillIcon
          ...
          tooltip="Github for Version control"
        />
      </div>
    </div>
  </section>
