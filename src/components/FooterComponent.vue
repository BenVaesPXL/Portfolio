  ...
  data() {
    return {
      ...
      socialLinks: [
        {
          name: "GitHub",
          url: "https://github.com/benvaes",
          icon: "github",
        },
        {
          name: "LinkedIn",
          url: "https://linkedin.com/in/benvaes",
          icon: "linkedin",
        },
        {
          name: "Email",
          url: "mailto:ben.vaes@example.com",
          icon: "email",
        },
      ],
      technologies: ["Vue.js", "JavaScript", "Tailwind CSS", "Node.js", "Vite"],
    };
  },
  methods: {
    scrollToTop() {
...
footer .dark .router-link-active {
  color: #818cf8;
}
